    ...
    <div class="table-responsive">
      <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
        ...
        <tbody>
          ...
          ELSE
          'NORMAL'
          END as status_produk, disc as diskon, unit_type as satuan, category_name as kategori_produk FROM mp_label JOIN mp_category ON mp_category.id = category_id ORDER BY product_name asc";
          $index = 0;
